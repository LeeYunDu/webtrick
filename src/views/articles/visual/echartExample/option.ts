...
import echartIcon01 from '@/assets/visual/echart-bar01.png'
import echartIcon02 from '@/assets/visual/echart-bar02.png'
import echartIcon03 from '@/assets/visual/echart-bar03.png'
import echartIcon04 from '@/assets/visual/echart-bar04.png'

export function getOption(name:string):object {
  const option = {
    instrumentPanel: () => {
      return {
        series: [{
      ...
      return {
        ...
        series: [
          ...
          },
          {
            ...
            data: [{
              value: 18,
              symbol: `image://${echartIcon01}`
            }, {
              value: 12,
              symbol: `image://${echartIcon02}`

            }, {
              value: 100,
              symbol: `image://${echartIcon03}`

            }, {
              value: 60,
              symbol: `image://${echartIcon04}`
